                ...
                <div class="row">
                            ...
                            <div class="row">
                                <figure class="product-main-image">
                                    <img id="product-zoom" src="/template/client/images/product/home7-product6.jpg"
                                        data-zoom-image="/template/client/images/product/home7-product6.jpg" alt="product image">
                                ...
                                <div id="product-zoom-gallery" class="product-image-gallery">
                                    <a class="product-gallery-item active" href="#"
                                        ...
                                        <img src="/template/client/images/product/home7-product6.jpg" alt="product side">
                                    </a>
                                    ...
                                    <a class="product-gallery-item" href="#"
                                        ...
                                        <img src="/template/client/images/product/home7-product1-1.jpg" alt="product cross">
                                    </a>
                    ...
                    <div class="col-md-6">
                        <div class="product-details">
                            <h1 class="product-title">Name</h1><!-- End .product-title -->
                ...
                <ul class="nav nav-pills justify-content-center" role="tablist">
                    ...
                    <li class="nav-item">
                        <a class="nav-link" id="product-shipping-link" data-toggle="tab" href="#product-shipping-tab"
                            role="tab" aria-controls="product-shipping-tab" aria-selected="false">Giao Hàng & Trả Lại</a>
                    </li>
                    <li class="nav-item">
