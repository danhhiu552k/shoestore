    ...
    <div class="intro-slider owl-carousel owl-simple owl-light owl-nav-inside" data-toggle="owl" data-owl-options='{"nav": false}'>
        <div class="intro-slide">
            <figure class="slide-image">
                <picture>
                    <source media="(max-width: 480px)" srcset="/template/client/images/product/slide-1.jpg">
                        <img src="/template/client/images/product/slide-1.jpg" alt="Image Desc">
                </picture>
        ...
        <div class="intro-slide">
            <figure class="slide-image">
                <picture>
                    <source media="(max-width: 480px)" srcset="/template/client/images/slider/home7-banner1.jpg">
                    <img src="/template/client/images/slider/home7-banner1.jpg" alt="Image Desc" >
                </picture>
            </figure><!-- End .slide-image -->
